			...
			<el-main class="main">
				...
				<el-form @submit.native.prevent="submit">
					...
					<div v-for="(data, dir) in answers" :key="dir">
						<el-radio-group class="radio" v-model="data.input" required>
					...
					<el-form-item>
						<el-button
							...
							@click="submit"
							:disabled="disabled"
						>{{disabled ? 'Select one item from each group' : 'Submit'}}</el-button>
					</el-form-item>
				</el-form>
...
export default class VelTime2 extends Vue {
	...
	public get figure() {
		...
		return { down: gravity, up: normalForce, left, right };
	}
